...
public class VpnProfileDataSource
{
	...
	public static final DbColumn[] COLUMNS = new DbColumn[] {
								...
								new DbColumn(KEY_USER_CERTIFICATE_PASSWORD, "TEXT", 16),
								...
								new DbColumn(KEY_DNS_SERVERS, "TEXT", 16),
								new DbColumn(KEY_READ_ONLY, "BOOL", 16),
							};
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
		{
			...
			if (oldVersion < 16)
			{
				...
				if (!col_names.contains(KEY_IKE_PROPOSAL)) {
					db.execSQL("ALTER TABLE " + TABLE_VPNPROFILE + " ADD " + KEY_IKE_PROPOSAL + " TEXT;");
				}

				if (!col_names.contains(KEY_ESP_PROPOSAL)) {
					db.execSQL("ALTER TABLE " + TABLE_VPNPROFILE + " ADD " + KEY_ESP_PROPOSAL + " TEXT;");
				}
