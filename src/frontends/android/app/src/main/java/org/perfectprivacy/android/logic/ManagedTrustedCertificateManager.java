...
import org.perfectprivacy.android.data.ManagedTrustedCertificateRepository;
...
public class ManagedTrustedCertificateManager
{
	...
	@NonNull
	final org.perfectprivacy.android.logic.ManagedTrustedCertificateInstaller certificateInstaller;
		...
		@NonNull final DatabaseHelper databaseHelper)
	{
		...
		this.certificateInstaller = new org.perfectprivacy.android.logic.ManagedTrustedCertificateInstaller(context);
	}
